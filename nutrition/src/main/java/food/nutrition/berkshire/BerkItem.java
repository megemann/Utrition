...
@Getter
@Document(collection = "berkshire")
@Data
@AllArgsConstructor
@NoArgsConstructor

public class BerkItem {
    @Id
    private ObjectId id;
    ...
    public BerkItem(String ss, Integer cal, Float fg, Float smg, Float cg, Float sg, Float pg, Float fig, String name, List<String> daysServed) {
        this.ss = ss;
        this.cal = cal;
        this.fg = fg;
        this.smg = smg;
