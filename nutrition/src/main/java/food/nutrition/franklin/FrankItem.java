...
@Getter
@Document(collection = "franklin")
@Data
@AllArgsConstructor
@NoArgsConstructor

public class FrankItem {
    @Id
    private ObjectId id;
    ...
    public FrankItem(String ss, Integer cal, Float fg, Float smg, Float cg, Float sg, Float pg, Float fig, String name, List<String> daysServed) {
        this.ss = ss;
        this.cal = cal;
        this.fg = fg;
        this.smg = smg;
